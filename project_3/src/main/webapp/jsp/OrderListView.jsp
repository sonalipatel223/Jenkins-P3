...
<body class="hm">
	...
	<div></div>
	<div>
		<form class="pb-5" action="<%=ORSView.ORDER_LIST_CTL%>"
			method="post">
			<jsp:useBean id="dto" class="in.co.rays.project_3.dto.OrderDTO"
				scope="request"></jsp:useBean>
			<%
				List list1 = (List) request.getAttribute("quality");
			%>
							...
							<%-- <div class="col-sm-2">
								<div class="input-group">
									...
									<%
										...
										map.put("best", "best");
										map.put("good", "good");
										map.put("very good", "very good");


										String htmlList = HTMLUtility.getList("quality", dto.getQuality(), map);
									%>
									<%=htmlList%></div>
 ...
 --%>
				...
				<div class="col-sm-2"><%=HTMLUtility.getList("quality", String.valueOf(dto.getQuality()), list1)%></div>
